    ...
    <aside className="hidden lg:block shrink-0" style={{ width: "225px", paddingRight: "25px" }}>
      <div className="sticky" style={{ top: "110px" }}>
        ...
        <div style={{ backgroundColor: "#fff", borderRadius: "10px", boxShadow: "0px 1px 6px 0px #ccc", overflow: "hidden", padding: "15px", marginBottom: "20px" }}>
          ...
          <div style={{ paddingTop: "10px" }}>
            ...
            <div style={{ textAlign: "center", color: "#666", fontSize: "13px", marginBottom: "10px" }}>
              該当プラン数
              <div>
                <span style={{ fontSize: "28px", fontWeight: "bold", color: "#333" }}>20</span>
        ...
        <div style={{ marginTop: "16px" }}>
          <a href="https://ishigaki-tours.com/tours-ferry/" target="_blank" rel="noopener noreferrer" className="block">
        ...
        <div style={{ marginTop: "12px" }}>
          <Link href="/campaign/premium-plan.html" className="block">
            <img src="/images/sidebar/premium-banner.webp" alt="ツアーズ厳選プレミアムプラン" style={{ width: "100%", borderRadius: "4px" }} />
          </Link>
        </div>
      </div>
    </aside>
