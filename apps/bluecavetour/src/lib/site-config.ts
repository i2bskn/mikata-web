...
export const visitorKvImageAlt = "石垣島・青の洞窟専門 厳選ツアーがいっぱい！";
...
export const administratorReasons = [
  { title: "会員登録不要で簡単予約", text: "石垣島青の洞窟ツアーズでは面倒な会員登録が不要。必要情報を入力して1分程度で予約が完結します。" },
  { title: "24時間WEB予約受付", text: "石垣島青の洞窟ツアーズは24時間いつでもWEBから簡単にご予約いただけます。" },
  { title: "石垣島青の洞窟ツアー最大規模のプラン取扱数", text: "青の洞窟のツアーに特化したアクティビティ予約サイトの中で最大規模のプラン数を取り扱っております。※2025年2月時点 当社調べ" },
...
export const columnArticles = [
  ...
  {
    href: "/column/snorkeling-beginner-guide",
...
<h2>おすすめスポット 3 選</h2>
<h3>1. 青の洞窟</h3>
<p>石垣島の北部、川平エリアからアクセスしやすい人気スポット。洞窟内に差し込む光が海を青く染め上げ、まるで別世界のような景観が広がります。</p>
<img src="/images/column/okinawa-bluecave.webp" alt="青の洞窟" />
<p>洞窟周辺ではカラフルな熱帯魚やウミガメに出会える可能性も高く、シュノーケリング初心者でも十分楽しめます。</p>
<h3>2. 米原ビーチ</h3>
<p>遠浅の地形と豊富な珊瑚礁が魅力のビーチ。ビーチからエントリーできるため、ボートが苦手な方にもおすすめです。</p>
<h3>3. 川平湾</h3>
<p>石垣島の代表的な観光地。グラスボートも楽しめるエリアで、シュノーケリングと観光をセットで満喫できます。</p>
 ...
 * bluecavetour 旧サイトには該当ボタンが存在しないため undefined（非表示）
 */
export const agencyContactHref: string | undefined = undefined;
