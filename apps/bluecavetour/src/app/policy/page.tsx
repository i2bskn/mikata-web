            ...
            <div style={{ fontSize: "16.8px", lineHeight: "2", color: "#333" }}>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    本サイトに掲載されている事業者（以下「掲載事業者」といいます）は、自己の責任において体験型アクティビティサービス及びこれらに付帯するサービス（以下「事業者提供サービス」といいます）を提供しており、当社は、事業者提供サービスの提供に関し何らの関与もしません。
                  </li>
                  <li>
                    ユーザーは、本サイト上で当社の指定する必要情報を入力することによって、事業者提供サービスの予約ができるものとします。なお、ユーザーに予約の申込みに対する承諾を通知した時点で、事業者とユーザーの間に事業者提供サービス利用契約（以下、「利用契約」といいます。）が成立するものとします。
                  </li>
                  <li>
                    前項の場合、当社は、予約の申込みを証するため、「予約番号」を記載した「予約確認メール」をユーザーが予め指定するメールアドレスに配信します。なお、「予約確認メール」は、利用契約の成立を証するものではなく、利用契約は前項各号に従って成立するものとします。
                  </li>
                  <li>
                    本条の定めに基づき掲載事業者とユーザーとの間で利用契約が成立した場合、ユーザーは、当該掲載事業者にて別途定めるキャンセル料の負担等の義務が自己に生じることを承諾したものとみなされます。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    ユーザーは、掲載事業者の提供する利用料金が変更されることを了承します。変更後の料金は、変更後に予約申込みをしたユーザーにのみ適用され、変更前に予約申込みをしたユーザーには変更前の利用料金が適用されます。
                  </li>
                  <li>
                    ユーザーの予約申込み後に利用料金が変更され、その後、ユーザーが予約内容を変更した場合でも、当該ユーザーには変更前の利用料金が適用されます。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    当社へ連絡し、予約のキャンセルを行う場合：当社が、ユーザーに対し、予約キャンセルを了承した旨を通知した時点
                  </li>
                  <li>
                    その他の方法による場合：当社が所定の方法に従い予約キャンセル完了の通知をした時点
                  </li>
                  <li>
                    ユーザーは、事業者提供サービス利用予定日に当該サービスを利用することができないことが判明したとき、速やかに当社へその旨連絡し、指示に従うものとします。なお、ユーザーがキャンセル料を支払う義務を負担している場合、本サービスで定めるキャンセル料を、所定の方法および期日までに支払うものとします。
                  </li>
                  <li>
                    当社および掲載事業者は、ユーザーが、事前に何らの連絡もなく事業者提供サービス利用予定日当日に姿を現さず、当該掲載事業者を利用しなかった場合には、無連絡キャンセルとみなし、当該ユーザーの本サービスを含む、本サイトに係る一切のサービスの利用停止または必要な措置（法的措置を含みます）を取ることができるものとします。なお、ユーザーは、当該掲載事業者が定めるキャンセル料を、所定の方法および期日までに支払わなければなりません。
                  </li>
                  <li>
                    ユーザーが予約のキャンセルを希望しない場合においても、当社が、ユーザーによる事業者提供サービス利用に係る予約内容につき、法令等に抵触すると判断しうる場合または合理的に不適切と判断できる場合には、当社は、当該予約をキャンセルする権利を有するものとします。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    ユーザーは、自己の責任において直接掲載事業者との契約を履行するものとし、事業者提供サービスに関する問い合わせ・要望等は当該掲載事業者に対して直接行うものとします。
                  </li>
                  <li>
                    前2項の他、ユーザーは、掲載事業者が別途定める条件・規則等を十分に理解し遵守するものとします。
                  </li>
                  <li>
                ...
                <ul style={{ paddingLeft: "20px", listStyleType: "disc" }}>
                  ...
                  <li>
                    事業者提供サービスの利用者またはユーザー個人の氏名、住所、電話番号、メールアドレス、クレジットカード番号等について、故意であるか否かを問わず虚偽または不備のある情報を登録する行為
                  </li>
                ...
                <ol start={5} style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  <li>
                    前項各号の一に該当するユーザーの行為によって、当社または第三者に損害が生じた場合、ユーザーはすべての法的責任を負担するものとし、当社および第三者に損害を与えないものとします。
                  </li>
                  <li>
                    第6条に基づき、当社が事業者提供サービス利用に係る予約をキャンセルした場合、ユーザーは、当該掲載事業者に係るキャンセル料を納めるものとします。
                  </li>
                  <li>
                    ユーザーは、事業者提供サービスの内容について苦情を有する場合、その場で当該苦情を当該掲載事業者に対して申し立てるものとします。
                  </li>
                  <li>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    当社は、ユーザーが前条の遵守事項に違反していると推測される場合、その他当社が本サービスの運営上不適当と合理的に判断した場合には、当該行為の詳細についてユーザーに確認させていただくことがあります。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    投稿された口コミについて当社はその内容を確認・審査し、それを他のユーザーに公開することができます。
                  </li>
                  <li>
                    投稿された口コミの権利は当社に帰属するものとし、本サイト及びその他のサイトにおいて利用できるものとします。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    本条の規定に違反して紛争が発生した場合、ユーザーは、自己の費用と責任において、当該紛争を解決するとともに、当社および第三者に一切の損害を与えないものとします。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    前項の規定に基づき、掲載事業者が変更された時点において、ユーザーと当該掲載事業者の間で利用契約が成立している場合には、当該契約は有効に存続するものとし、掲載事業者の変更は、当該利用契約に対し何らの影響も及ぼさないものとします。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    当社は、事業者提供サービス等について何らの保証もいたしません。また、掲載事業者等に関する情報は、当該掲載事業者からの提出をもって本サイトに登録したものであり、当社は、当該情報の正確性、完全性または有用性等についても保証いたしません。万一、事業者提供サービス等に関連して何らかのトラブルがユーザーと掲載事業者の間で生じた場合にも、当該トラブルが当社の責に帰すべき事由による場合を除き、当社は何らの責任も負いません。
                  </li>
                  <li>
                    自然災害、回線の輻輳（ふくそう）、機器の障害または保守のための停止、掲載事業者の参画の終了等による情報の損失、遅延、誤送、または第三者による情報の改竄や漏洩等により発生した損害について、当社の責に帰すべき事由による場合を除き、当社は、何ら責任を負いません。
                  </li>
                  <li>
                    前各項の他本サービスに関連して発生したユーザーと掲載事業者間の一切の紛争について、当該紛争が当社の責に帰すべき事由による場合を除き、当社は何ら責任を負いません。
                  </li>
                  <li>
                    当社は、本サイト上において、他社が運営する旅行予約サイトへのリンク等を設置することがあります。当該リンク先の情報について当社は正確性を保証せず、当該リンク先でのサービスの提供、契約、トラブル等については、当社は一切の責任を負いません。
                  </li>
                  <li>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    本規約および諸注意等の変更後、ユーザーが本サービスを利用した場合、当社はユーザーが変更後の本規約および諸注意等を承諾したものとみなします。
                  </li>
                </ol>
              </section>
              ...
              <section style={{ marginBottom: "28px" }}>
                ...
                <ol style={{ paddingLeft: "20px", listStyleType: "decimal" }}>
                  ...
                  <li>
                    ユーザーが前項に違反した場合、当社は、当該ユーザーと当該掲載事業者の利用契約をキャンセルし、または掲載情報を削除する権利を留保するとともに、当該ユーザーの本サービスを含む、本サイトに係る一切のサービスの利用停止、もしくは損害賠償請求等必要な措置（法的措置を含みます）を取ることができるものとします。
                  </li>
                </ol>
              </section>
