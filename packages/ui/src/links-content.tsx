...
const defaultLinkItems: LinkItem[] = [
  {
    name: "西表島ツアーズ",
...
export const LinksContent: FC<LinksContentProps> = ({ items = defaultLinkItems }) => {
  return (
    <>
          ...
          <div key={item.href} style={{ marginBottom: "16px" }}>
            <p>
              <a href={item.href} target="_blank" rel="noopener noreferrer">
                <img src={item.imgSrc} alt={item.name} style={{ maxWidth: "176px", height: "auto" }} />
              </a>
            </p>
